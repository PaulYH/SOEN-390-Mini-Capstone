...
const OwnerFinanceDashboard = () => {
  ...
  return (
    <>
      <Button type='button' style={{ margin: '20px' }} onClick={handleClick}>
        Back
      </Button>
      <div
      ...
      <h1 className='ms-5' style={{ color: 'black', marginBottom: '-20px' }}>
        Finances
      </h1>
      <div className={styles.dashboardHeader}>
        <div className='row' >
          <div className='col-lg-12 col-md-12 ms-4 me-4 d-flex justify-content-center'  style={{ flexDirection: 'column', alignContent: 'center', gap: '10px' }}>
            ...
            >
              <div className='progress m-3'>
                <div
                  ...
                  role='progressbar'
                  style={{ width: '25%', backgroundColor: '#7067E1' }}
                  aria-valuenow='25'
                  aria-valuemin='0'
                  aria-valuemax='100'
                >
              ...
              <div className={styles.amount} style={{ marginTop: '15px' }}>
                Total amount: ${' '}
                <span className='badge badge-size bg-light text-dark'>
              ...
              <div className={styles.amount}>
                Monthly Payments: ${' '}
                <span className='badge badge-size bg-light text-dark'>
                  {userData.monthlyPayment.toLocaleString()}
                </span>
              </div>
              <div className={styles.amount}>
                Remaining Amount:{' '}
                <span className='badge badge-size bg-light text-dark'>
                  ${userData.remainingAmount.toLocaleString()}
                </span>{' '}
              </div>
              <div className='m-3'>
                Last payment made on: {userData.lastPaymentDate} <br />
            ...
            <div className={styles.amount}>
              Remaining Amount:{' '}
              <span class='badge badge-size bg-light text-dark'>
                ${userData.remainingAmount.toLocaleString()}
              </span>{' '}
            </div>
            <div className='m-3'>
