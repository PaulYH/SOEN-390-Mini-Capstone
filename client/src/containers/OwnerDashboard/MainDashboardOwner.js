...
const MainDashboardOwner = () => {
  ...
  const fetchUserInfo = async () => {
    ...
    return (
        <>
          <img src={require('../../assets/logo.png')} alt="logo" className="d-flex justify-content-center"/>
          <div className="container">
            <div className="row" id="row-dashboard">
    ...
    <div className="col-lg-4">
        <div className="card mb-4">
          <div className="card-body text-center">
            <img src={require('../../assets/profile_default.png')} alt="avatar"
              className="rounded-circle img-fluid" style={{width: '150px', marginBottom:'7px'}}/>
        ...
        <a href="SubmittedRequests" className="btn btn-primary">See Details</a>
      </div>
    </div>
    <div class="w-100"></div>
    <div className="col-lg-6">
      ...
      <div className="card-body">
        ...
        <a href="Amenities" className="btn btn-primary">Go somewhere</a>
      </div>
    </div>
    </div>
    </div>
    ...
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">Amenities</h5>
        <p classname="card-text">With supporting text below as a natural lead-in to additional content.</p>
        <a href="OwnerFinance" className="btn btn-primary">Go somewhere</a>
      </div>
    </div>
    </div>
